...
class MessageRequestController extends AbstractController
{
     ...
     */
    public function index(MessageRequestRepository $messageRequestRepository): Response
    {
        return $this->render('message_request/index.html.twig', ['message_requests' => $messageRequestRepository->findAll()]);
    }
